  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Ecommerce app: Transforming your business with powerful backend services for a seamless ecommerce experience"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Ecommerce app: Transforming your business with powerful backend services for a seamless ecommerce experience`}
            </Text>
            <Box
